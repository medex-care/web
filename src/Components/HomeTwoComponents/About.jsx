      ...
      <div className="container">
        <div className="grid grid-cols-12 gap-[30px]">
          <div className="xl:col-span-7 lg:col-span-6 col-span-12">
            <img src={"https://saneware.de/wp-content/uploads/2021/01/Das_Krankenhauszukunftsgesetz.jpg"} alt="" className=" block w-full" />
          </div>
          <div className="xl:col-span-5 lg:col-span-6 col-span-12">
            <div className="mini-title">Über uns</div>
            <h4 className="column-title ">
            Wir vermitteln {" "}
              <span className="shape-bg">erstklassiges</span>medizinisches Personal
            </h4>
            <div className=" mb-8">
